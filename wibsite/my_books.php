...
<body>
    ...
    <div class="container">
        ...
        <?php
        // Filter out rejected and returned books
        $filtered_books = array_filter($borrowed_books, function($book) {
                ...
                <?php foreach ($filtered_books as $book): ?>
                    <div class="book-card">
                        ...
                        <div class="book-details">
                            ...
                            <?php if ($book['status'] === 'approved' && empty($book['return_date'])): ?>
                            ...
                            <?php elseif ($book['status'] === 'pending'): ?>
                                <span class="pending-status">Pending Approval</span>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endforeach; ?>
